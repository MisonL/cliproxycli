      ...
      <header className="hero-wrapper">
        <div className="hero-content">
          <div className="flex-column gap-xs">
            ...
            <h1 className="hero-title">{t('nav.oauth', { defaultValue: 'OAuth' })}</h1>
            <p className="hero-subtitle">
              {t('auth_login.subtitle') || 'Connect with upstream providers via OAuth or Cookie authentication to automatically sync credentials.'}
            </p>
          </div>
        </div>
      </header>
